...
namespace eae6320
{
	namespace Assets
	{
		...
		private:
			...
			static eae6320::cResult LoadTableValues_vertexArray_vertices_normal( lua_State& io_luaState, std::vector<Graphics::VertexFormats::sMesh>& io_vertexData, int i_index);
			static eae6320::cResult LoadTableValues_vertexArray_vertices_normal_values( lua_State& io_luaState, std::vector<Graphics::VertexFormats::sMesh>& io_vertexData, int i_index);
			static eae6320::cResult LoadTableValues_vertexArray_vertices_tangent( lua_State& io_luaState, std::vector<Graphics::VertexFormats::sMesh>& io_vertexData, int i_index);
			static eae6320::cResult LoadTableValues_vertexArray_vertices_tangent_values( lua_State& io_luaState, std::vector<Graphics::VertexFormats::sMesh>& io_vertexData, int i_index);
			static eae6320::cResult LoadTableValues_vertexArray_vertices_bitangent( lua_State& io_luaState, std::vector<Graphics::VertexFormats::sMesh>& io_vertexData, int i_index);
			static eae6320::cResult LoadTableValues_vertexArray_vertices_bitangent_values( lua_State& io_luaState, std::vector<Graphics::VertexFormats::sMesh>& io_vertexData, int i_index);
