...
void eae6320::cMyGame::SubmitDataToBeRendered(const float i_elapsedSecondCount_systemTime, const float i_elapsedSecondCount_sinceLastSimulationUpdate)
{
	...
	eae6320::Graphics::SubmitGameObject(m_object4->GetMesh(), m_object4->GetEffect(), m_object4->GetTransform(i_elapsedSecondCount_sinceLastSimulationUpdate));
	eae6320::Graphics::SubmitGameObject(m_object5->GetMesh(), m_object5->GetEffect(), m_object5->GetTransform(i_elapsedSecondCount_sinceLastSimulationUpdate));
}
...
eae6320::cResult eae6320::cMyGame::Initialize()
{
	...
	// Initialize the shading data
	{
		if ( !( result = eae6320::Graphics::cEffect::Load( s_Effect3, "data/Effects/white.effect") ) )
		{
			EAE6320_ASSERT( false );
			goto OnExit;
		}
	...
	// Initialize the shading data
	{
		if ( !( result = eae6320::Graphics::cEffect::Load( s_Effect4, "data/Effects/red.effect") ) )
		{
			EAE6320_ASSERT( false );
			goto OnExit;
		}
	...
	// Initialize the shading data
	{
		if ( !( result = eae6320::Graphics::cEffect::Load( s_Effect5, "data/Effects/white.effect") ) )
		{
			EAE6320_ASSERT( false );
			goto OnExit;
		}
