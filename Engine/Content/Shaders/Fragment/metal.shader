	...
	)
{
	...
	float3 dReflectedDirection = reflect(i_position_world - g_camera_position, tangentNormal);
	float4 environmentColor = SampleTextureCube(g_environmentTexture, g_diffuse_samplerState, dReflectedDirection) * 0.2;
