...
void eae6320::Graphics::SubmitDrawCommand(unsigned int i_distance, const cMesh::Handle& i_mesh, const cMaterial::Handle& i_material, Math::cMatrix_transformation& i_transform_localToWorld, const Math::cMatrix_transformation& i_transform_localToProjected, float i_height, bool firstSubmit)
{
	...
	s_dataBeingSubmittedByApplicationThread->constantData_perMaterial[i_material.GetIndex()].g_height = i_height;
