...
eae6320::cResult eae6320::Graphics::cMesh::Load(const char* const i_path, cMesh*& o_mesh)
{
	...
	std::vector<VertexFormats::sMesh> vertexData;
	std::vector<uint16_t> indexData;

	{
		if ( !( result = LoadAsset( i_path, vertexData, indexData )) )
		{
	...
	if ( !( result = newMesh->InitializeGeometry( vertexData, indexData) ) )
	{
		EAE6320_ASSERTF( false, "Initialization of new mesh failed" );
		goto OnExit;
	}
...
eae6320::cResult eae6320::Graphics::cMesh::LoadAsset(const char* const i_path, std::vector<VertexFormats::sMesh>& io_vertexData, std::vector<uint16_t>& io_indexData)
{
...
eae6320::cResult eae6320::Graphics::cMesh::LoadTableValues(lua_State& io_luaState, std::vector<VertexFormats::sMesh>& io_vertexData, std::vector<uint16_t>& io_indexData)
{
	auto result = eae6320::Results::Success;
...
eae6320::cResult eae6320::Graphics::cMesh::LoadTableValues_vertexArray(lua_State& io_luaState, std::vector<VertexFormats::sMesh>& io_vertexData)
{
	auto result = eae6320::Results::Success;
...
eae6320::cResult eae6320::Graphics::cMesh::LoadTableValues_vertexArray_vertices(lua_State& io_luaState, std::vector<VertexFormats::sMesh>& io_vertexData)
{
	auto result = eae6320::Results::Success;
...
eae6320::cResult eae6320::Graphics::cMesh::LoadTableValues_vertexArray_vertices_position(lua_State& io_luaState, std::vector<VertexFormats::sMesh>& io_vertexData)
{
	auto result = eae6320::Results::Success;
...
eae6320::cResult eae6320::Graphics::cMesh::LoadTableValues_vertexArray_vertices_position_values(lua_State& io_luaState, std::vector<VertexFormats::sMesh>& io_vertexData)
{
	auto result = eae6320::Results::Success;

	std::cout << "Iterating through every position value:" << std::endl;
	VertexFormats::sMesh position;
...
eae6320::cResult eae6320::Graphics::cMesh::LoadTableValues_indexArray(lua_State& io_luaState, std::vector<uint16_t>& io_indexData)
{
	auto result = eae6320::Results::Success;
...
eae6320::cResult eae6320::Graphics::cMesh::LoadTableValues_indexArray_indices(lua_State& io_luaState, std::vector<uint16_t>& io_indexData)
{
	auto result = eae6320::Results::Success;
