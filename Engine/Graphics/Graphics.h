...
namespace eae6320
{
	namespace Graphics
	{
		...
		void SubmitLighting(const sColor& i_color, const sColor& i_directionalLightColor, const Math::sVector& i_lightDirection, const Math::sVector& i_pointLightPosition);
